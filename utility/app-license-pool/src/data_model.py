...
class AppLicensePool(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'App License Pool'
        self._name = name
    ...
    def create_from_context(cls, context):
        ...
        :return:
        :rtype AppLicensePool
        """
        result = AppLicensePool(name=context.resource.name)
    ...
    def pool_limit(self):
        ...
        :rtype: float
        """
        return self.attributes['App License Pool.pool limit'] if 'App License Pool.pool limit' in self.attributes else None

    @pool_limit.setter
    def pool_limit(self, value='1'):
        """
        number of total licenses
        :type value: float
        """
        self.attributes['App License Pool.pool limit'] = value
    ...
    def pool_name(self):
        ...
        :rtype: str
        """
        return self.attributes['App License Pool.pool name'] if 'App License Pool.pool name' in self.attributes else None
    ...
    def pool_name(self, value):
        ...
        :type value: str
        """
        self.attributes['App License Pool.pool name'] = value
    ...
    def user(self):
        ...
        :rtype: str
        """
        return self.attributes['App License Pool.User'] if 'App License Pool.User' in self.attributes else None
    ...
    def user(self, value):
        ...
        :type value: str
        """
        self.attributes['App License Pool.User'] = value
    ...
    def password(self):
        ...
        :rtype: string
        """
        return self.attributes['App License Pool.Password'] if 'App License Pool.Password' in self.attributes else None
    ...
    def password(self, value):
        ...
        :type value: string
        """
        self.attributes['App License Pool.Password'] = value
    ...
    def enable_password(self):
        ...
        :rtype: string
        """
        return self.attributes['App License Pool.Enable Password'] if 'App License Pool.Enable Password' in self.attributes else None
    ...
    def enable_password(self, value):
        ...
        :type value: string
        """
        self.attributes['App License Pool.Enable Password'] = value
    ...
    def power_management(self):
        ...
        :rtype: bool
        """
        return self.attributes['App License Pool.Power Management'] if 'App License Pool.Power Management' in self.attributes else None
    ...
    def power_management(self, value=True):
        ...
        :type value: bool
        """
        self.attributes['App License Pool.Power Management'] = value
    ...
    def sessions_concurrency_limit(self):
        ...
        :rtype: float
        """
        return self.attributes['App License Pool.Sessions Concurrency Limit'] if 'App License Pool.Sessions Concurrency Limit' in self.attributes else None
    ...
    def sessions_concurrency_limit(self, value='1'):
        ...
        :type value: float
        """
        self.attributes['App License Pool.Sessions Concurrency Limit'] = value
    ...
    def snmp_read_community(self):
        ...
        :rtype: string
        """
        return self.attributes['App License Pool.SNMP Read Community'] if 'App License Pool.SNMP Read Community' in self.attributes else None
    ...
    def snmp_read_community(self, value):
        ...
        :type value: string
        """
        self.attributes['App License Pool.SNMP Read Community'] = value
    ...
    def snmp_write_community(self):
        ...
        :rtype: string
        """
        return self.attributes['App License Pool.SNMP Write Community'] if 'App License Pool.SNMP Write Community' in self.attributes else None
    ...
    def snmp_write_community(self, value):
        ...
        :type value: string
        """
        self.attributes['App License Pool.SNMP Write Community'] = value
    ...
    def snmp_v3_user(self):
        ...
        :rtype: str
        """
        return self.attributes['App License Pool.SNMP V3 User'] if 'App License Pool.SNMP V3 User' in self.attributes else None
    ...
    def snmp_v3_user(self, value):
        ...
        :type value: str
        """
        self.attributes['App License Pool.SNMP V3 User'] = value
    ...
    def snmp_v3_password(self):
        ...
        :rtype: string
        """
        return self.attributes['App License Pool.SNMP V3 Password'] if 'App License Pool.SNMP V3 Password' in self.attributes else None
    ...
    def snmp_v3_password(self, value):
        ...
        :type value: string
        """
        self.attributes['App License Pool.SNMP V3 Password'] = value
    ...
    def snmp_v3_private_key(self):
        ...
        :rtype: str
        """
        return self.attributes['App License Pool.SNMP V3 Private Key'] if 'App License Pool.SNMP V3 Private Key' in self.attributes else None
    ...
    def snmp_v3_private_key(self, value):
        ...
        :type value: str
        """
        self.attributes['App License Pool.SNMP V3 Private Key'] = value
    ...
    def snmp_v3_authentication_protocol(self):
        ...
        :rtype: str
        """
        return self.attributes['App License Pool.SNMP V3 Authentication Protocol'] if 'App License Pool.SNMP V3 Authentication Protocol' in self.attributes else None
    ...
    def snmp_v3_authentication_protocol(self, value='No Authentication Protocol'):
        ...
        :type value: str
        """
        self.attributes['App License Pool.SNMP V3 Authentication Protocol'] = value
    ...
    def snmp_v3_privacy_protocol(self):
        ...
        :rtype: str
        """
        return self.attributes['App License Pool.SNMP V3 Privacy Protocol'] if 'App License Pool.SNMP V3 Privacy Protocol' in self.attributes else None
    ...
    def snmp_v3_privacy_protocol(self, value='No Privacy Protocol'):
        ...
        :type value: str
        """
        self.attributes['App License Pool.SNMP V3 Privacy Protocol'] = value
    ...
    def snmp_version(self):
        ...
        :rtype: str
        """
        return self.attributes['App License Pool.SNMP Version'] if 'App License Pool.SNMP Version' in self.attributes else None
    ...
    def snmp_version(self, value=''):
        ...
        :type value: str
        """
        self.attributes['App License Pool.SNMP Version'] = value
    ...
    def enable_snmp(self):
        ...
        :rtype: bool
        """
        return self.attributes['App License Pool.Enable SNMP'] if 'App License Pool.Enable SNMP' in self.attributes else None
    ...
    def enable_snmp(self, value=True):
        ...
        :type value: bool
        """
        self.attributes['App License Pool.Enable SNMP'] = value
    ...
    def disable_snmp(self):
        ...
        :rtype: bool
        """
        return self.attributes['App License Pool.Disable SNMP'] if 'App License Pool.Disable SNMP' in self.attributes else None
    ...
    def disable_snmp(self, value=False):
        ...
        :type value: bool
        """
        self.attributes['App License Pool.Disable SNMP'] = value
    ...
    def console_server_ip_address(self):
        ...
        :rtype: str
        """
        return self.attributes['App License Pool.Console Server IP Address'] if 'App License Pool.Console Server IP Address' in self.attributes else None
    ...
    def console_server_ip_address(self, value):
        ...
        :type value: str
        """
        self.attributes['App License Pool.Console Server IP Address'] = value
    ...
    def console_user(self):
        ...
        :rtype: str
        """
        return self.attributes['App License Pool.Console User'] if 'App License Pool.Console User' in self.attributes else None
    ...
    def console_user(self, value):
        ...
        :type value: str
        """
        self.attributes['App License Pool.Console User'] = value
    ...
    def console_port(self):
        ...
        :rtype: float
        """
        return self.attributes['App License Pool.Console Port'] if 'App License Pool.Console Port' in self.attributes else None
    ...
    def console_port(self, value):
        ...
        :type value: float
        """
        self.attributes['App License Pool.Console Port'] = value
    ...
    def console_password(self):
        ...
        :rtype: string
        """
        return self.attributes['App License Pool.Console Password'] if 'App License Pool.Console Password' in self.attributes else None
    ...
    def console_password(self, value):
        ...
        :type value: string
        """
        self.attributes['App License Pool.Console Password'] = value
    ...
    def cli_connection_type(self):
        ...
        :rtype: str
        """
        return self.attributes['App License Pool.CLI Connection Type'] if 'App License Pool.CLI Connection Type' in self.attributes else None
    ...
    def cli_connection_type(self, value='Auto'):
        ...
        :type value: str
        """
        self.attributes['App License Pool.CLI Connection Type'] = value
    ...
    def cli_tcp_port(self):
        ...
        :rtype: float
        """
        return self.attributes['App License Pool.CLI TCP Port'] if 'App License Pool.CLI TCP Port' in self.attributes else None
    ...
    def cli_tcp_port(self, value):
        ...
        :type value: float
        """
        self.attributes['App License Pool.CLI TCP Port'] = value
    ...
    def backup_location(self):
        ...
        :rtype: str
        """
        return self.attributes['App License Pool.Backup Location'] if 'App License Pool.Backup Location' in self.attributes else None
    ...
    def backup_location(self, value):
        ...
        :type value: str
        """
        self.attributes['App License Pool.Backup Location'] = value
    ...
    def backup_type(self):
        ...
        :rtype: str
        """
        return self.attributes['App License Pool.Backup Type'] if 'App License Pool.Backup Type' in self.attributes else None
    ...
    def backup_type(self, value='File System'):
        ...
        :type value: str
        """
        self.attributes['App License Pool.Backup Type'] = value
    ...
    def backup_user(self):
        ...
        :rtype: str
        """
        return self.attributes['App License Pool.Backup User'] if 'App License Pool.Backup User' in self.attributes else None
    ...
    def backup_user(self, value):
        ...
        :type value: str
        """
        self.attributes['App License Pool.Backup User'] = value
    ...
    def backup_password(self):
        ...
        :rtype: string
        """
        return self.attributes['App License Pool.Backup Password'] if 'App License Pool.Backup Password' in self.attributes else None
    ...
    def backup_password(self, value):
        ...
        :type value: string
        """
        self.attributes['App License Pool.Backup Password'] = value
...
class ResourcePort(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'App License Pool.ResourcePort'
        self._name = name
    ...
    def mac_address(self):
        ...
        :rtype: str
        """
        return self.attributes['App License Pool.ResourcePort.MAC Address'] if 'App License Pool.ResourcePort.MAC Address' in self.attributes else None
    ...
    def mac_address(self, value=''):
        ...
        :type value: str
        """
        self.attributes['App License Pool.ResourcePort.MAC Address'] = value
    ...
    def ipv4_address(self):
        ...
        :rtype: str
        """
        return self.attributes['App License Pool.ResourcePort.IPv4 Address'] if 'App License Pool.ResourcePort.IPv4 Address' in self.attributes else None
    ...
    def ipv4_address(self, value):
        ...
        :type value: str
        """
        self.attributes['App License Pool.ResourcePort.IPv4 Address'] = value
    ...
    def ipv6_address(self):
        ...
        :rtype: str
        """
        return self.attributes['App License Pool.ResourcePort.IPv6 Address'] if 'App License Pool.ResourcePort.IPv6 Address' in self.attributes else None
    ...
    def ipv6_address(self, value):
        ...
        :type value: str
        """
        self.attributes['App License Pool.ResourcePort.IPv6 Address'] = value
    ...
    def port_speed(self):
        ...
        :rtype: str
        """
        return self.attributes['App License Pool.ResourcePort.Port Speed'] if 'App License Pool.ResourcePort.Port Speed' in self.attributes else None
    ...
    def port_speed(self, value):
        ...
        :type value: str
        """
        self.attributes['App License Pool.ResourcePort.Port Speed'] = value
...
class GenericPowerPort(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'App License Pool.GenericPowerPort'
        self._name = name
    ...
    def model(self):
        ...
        :rtype: str
        """
        return self.attributes['App License Pool.GenericPowerPort.Model'] if 'App License Pool.GenericPowerPort.Model' in self.attributes else None
    ...
    def model(self, value):
        ...
        :type value: str
        """
        self.attributes['App License Pool.GenericPowerPort.Model'] = value
    ...
    def serial_number(self):
        ...
        :rtype: str
        """
        return self.attributes['App License Pool.GenericPowerPort.Serial Number'] if 'App License Pool.GenericPowerPort.Serial Number' in self.attributes else None
    ...
    def serial_number(self, value):
        ...
        :type value: str
        """
        self.attributes['App License Pool.GenericPowerPort.Serial Number'] = value
    ...
    def version(self):
        ...
        :rtype: str
        """
        return self.attributes['App License Pool.GenericPowerPort.Version'] if 'App License Pool.GenericPowerPort.Version' in self.attributes else None
    ...
    def version(self, value):
        ...
        :type value: str
        """
        self.attributes['App License Pool.GenericPowerPort.Version'] = value
    ...
    def port_description(self):
        ...
        :rtype: str
        """
        return self.attributes['App License Pool.GenericPowerPort.Port Description'] if 'App License Pool.GenericPowerPort.Port Description' in self.attributes else None
    ...
    def port_description(self, value):
        ...
        :type value: str
        """
        self.attributes['App License Pool.GenericPowerPort.Port Description'] = value
