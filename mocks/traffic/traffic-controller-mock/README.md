...
### **Traffic Controller Mock**
**Traffic Controller Mock** provides you with connectivity and management capabilities such as device structure discovery and power management for the resource. 
...
▪ **Chassis Traffic Controller Mock** , which provides data model and autoload functionality to model and load the chassis to resource management.

▪ **Controller Traffic Controller Mock (service)**, which provides functionality to load test configuration, run tests, get test results, etc.
...
Release: **Traffic Controller Mock**

▪ CloudShell version: **[Version Number]**

▪ Chassis Traffic Controller Mock: CloudShell version **[Version Number]**

▪ Controller Traffic Controller Mock: CloudShell version **[Version Number]**
...
#### **Traffic Controller Mock Attributes**
...
The **Traffic Controller Mock** is available from the [Quali Community Integrations](https://community.quali.com/integrations) page. 
...
|:---|:---|
|TrafficControllerMock.zip|Device shell package|
|Traffic_Controller_Mock_offline_dependencies.zip|Shell Python dependencies (for offline deployments only)|

# Importing and Configuring the Shell
This section describes how to import the **Traffic Controller Mock** and configure and modify the shell’s devices.
...
**To associate the Traffic Controller Mock 2G service to a domain:**
...
For release updates, see the shell's [GitHub releases page](https://github.com/QualiSystems/TrafficControllerMock/releases). 
