...
### **L2 Mock Dynamic**
**L2 Mock Dynamic** shell provides you with connectivity and management capabilities such as device structure discovery and power management for the resource. 

For more information on the device, see the vendor's official product documentation.

### Standard version
**L2 Mock Dynamic** is based on the Networking Shell Standard version **5.0.4**.
...
The **L2 Mock Dynamic** shell is available from the [Quali Community Integrations](https://community.quali.com/integrations) page. 
...
|:---|:---|
|L2MockDynamic.zip|Device shell package|
|L2_Mock_Dynamic_offline_dependencies.zip|Shell Python dependencies (for offline deployments only)|

# Importing and Configuring the Shell
This section describes how to import the **L2 Mock Dynamic** shell and configure and modify the shell’s devices.
...
1. Download the *L2_Mock_Dynamic_offline_dependencies.zip* file, see [Downloading the Shell](#downloading-the-shell).
...
**To create a resource for the device:**
  ...
  2. From the list, select **L2 Mock Dynamic**.
...
For release updates, see the shell's [GitHub releases page](https://github.com/QualiSystems/L2MockDynamic/releases).
